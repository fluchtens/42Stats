...
export class CredentialController {
  ...
  @Put("credential/:id")
  @HttpCode(HttpStatus.OK)
  async updateCredential(@Param("id") id: number, @Body() updateCredentialDto: UpdateCredentialDto) {
    return await this.credentialService.updateCredential(id, updateCredentialDto);
  }
}
